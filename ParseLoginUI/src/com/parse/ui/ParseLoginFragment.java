...
public class ParseLoginFragment extends ParseLoginFragmentBase {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    Shader textShader=new LinearGradient(0, 0, 0, parseLoginButton.getPaint().getTextSize(),
            new int[]{Color.rgb(253, 255, 26), Color.rgb(250, 100, 22)},
            new float[]{0, 1}, Shader.TileMode.CLAMP);
    parseLoginButton.getPaint().setShader(textShader);
    Typeface XLight = Typeface.createFromAsset(getActivity().getAssets(), "fonts/GothamXLight.otf");
    parseLoginButton.setTypeface(XLight);
    Shader textShader2=new LinearGradient(0, 0, 0, parseSignupButton.getPaint().getTextSize(),
            new int[]{Color.rgb(253, 255, 26), Color.rgb(250, 100, 22)},
            new float[]{0, 1}, Shader.TileMode.CLAMP);
    parseSignupButton.getPaint().setShader(textShader2);

    parseSignupButton.setTypeface(XLight);
