...
public class ParseSignupFragment extends ParseLoginFragmentBase implements OnClickListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    Shader textShader=new LinearGradient(0, 0, 0, createAccountButton.getPaint().getTextSize(),
            new int[]{Color.rgb(253, 255, 26), Color.rgb(250, 100, 22)},
            new float[]{0, 1}, Shader.TileMode.CLAMP);
    createAccountButton.getPaint().setShader(textShader);
    Typeface XLight = Typeface.createFromAsset(getActivity().getAssets(), "fonts/GothamXLight.otf");
    createAccountButton.setTypeface(XLight);
