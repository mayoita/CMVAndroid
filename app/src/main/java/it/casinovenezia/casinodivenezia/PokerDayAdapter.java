 ...
 */
public class PokerDayAdapter extends BaseAdapter {
    ...
    public PokerDayAdapter(Context context, int theWidth) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.poker_day, parent, false);
            //configure view holder
            mViewHolder = new ViewHolder();
            mViewHolder.text = (TextView) convertView.findViewById(R.id.poker_day);
